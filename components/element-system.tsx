...
export function ElementSystem() {
  return (
    <section id="system" className="mx-auto max-w-6xl px-5 py-20">
      <SectionHeading
        step="5"
        title="Система элементов и носители"
        intro="На основе пяти цветов и семи пиктограмм созданы три типа навигационных и информационных носителей: вертикальный тотем, горизонтальный маркер объекта и информационный стенд. Все элементы работают по единому принципу сетки и типографики."
      />
